      ...
      {scholarships.length === 0 ? (
        ...
        <div className="space-y-3 max-h-96 overflow-y-auto">
          {scholarships.map(scholarship => (
            <div
              key={`${scholarship.eventType || 'deadline'}-${scholarship.id}`}
            ...
            >
              <div className="flex items-start justify-between mb-2">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    {scholarship.eventType === 'interview' && (
                      <span className="inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-bold bg-purple-100 dark:bg-purple-900/50 text-purple-700 dark:text-purple-300 flex-shrink-0">
                        🎤 Interview
                      </span>
                    )}
              ...
              <div className="flex items-center justify-between text-sm">
                <div className="flex items-center">
                  ...
                  <span className="font-medium">{formatDate(scholarship.eventDate || scholarship.deadline)}</span>
                </div>

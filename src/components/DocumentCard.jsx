      ...
      <div className="space-y-4">
        <div className="flex items-start justify-between">
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm text-gray-500 mt-1">{getTypeLabel(document.type)}</p>
          </div>
          ...
          {requiredByScholarships.length > 0 && (
            <div>
              <div className="flex items-center justify-between">
                <p className="text-sm text-gray-600">{isComplete ? 'Used by' : 'Waiting for'}</p>
              ...
              <div className="flex flex-wrap gap-1.5 mt-2">
                {visibleScholarships.map((s) => (
                  <button
                    ...
                    className="px-2 py-1 rounded-md text-xs font-medium bg-gray-50 text-gray-700 hover:bg-gray-100 border border-gray-200 transition-colors"
